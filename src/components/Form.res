...
module Make = (
  ...
  let make = (
    ...
    let divider =
      <div className="mt-4 mb-4 w-full border-2 border-solid rounded-full border-tertiary" />
      ...
      <>
        ...
        {if !collapsible {
          <div className="flex flex-wrap w-full justify-around gap-4 mt-4">
            ...
            <Button.Small onClick={retrieveFileContents} style="py-2 px-4">
        ...
        <div
          ...
          | Some(formData) =>
            try {
              <>
                <div className="pr-2 font-semibold"> {FormInfos.resultLabel} </div>
